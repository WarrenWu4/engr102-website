...
export default function LearningContent(props) {
    ...
    if (props.pageNum === 0) {
        ...
        <div className="learningcontent-container" style={{flexDirection:align}}>
            <div className="learningcontent-img" style={{display:showImage, backgroundImage:`url(../../src/assets/${props.pages[props.pageNum].img}`, position:"absolute", top: "5rem"}}></div>
    ...
    //otherwise show normal view structure
        ...
        <div className="learningcontent-container" style={{flexDirection:align}}>
            ...
            <div className="learningcontent-img" style={{width: "40vw", height:"60vh", display:showImage, backgroundImage:`url(../../src/assets/${props.pages[props.pageNum].img}`}}></div>
        </div>;
    }
