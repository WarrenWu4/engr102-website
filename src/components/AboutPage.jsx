...
const TaCard = ({profile, name, special}) => {
    return (
        <button type="button" className="rounded-[0.4rem] bg-neutral-700 px-[1.6rem] py-[1.4rem] flex items-center w-[36rem] hover:scale-[102%] transition-all duration-[0.4s] shadow-review-card">
    ...
    return (
        <>
            <div className="max-w-[1440px] w-full px-[1.6rem] md:px-[3.2rem] xl:px-[6.4rem] flex flex-col items-center pb-[10.8rem]">
                ...
                <div className="font-bold text-h1 text-neutral-100 flex justify-center">Meet the TAs</div>
                <div className="w-[10rem] h-[0.4rem] bg-neutral-100 my-[3.2rem] opacity-20"/>

                <div className="p-[3.2rem] bg-neutral-800 rounded-[0.8rem] mb-[12rem] grid grid-cols-3 gap-[3.2rem]">
                ...
                <div className="grid grid-cols-3 gap-[3.2rem] p-[3.2rem] bg-neutral-800 rounded-[0.8rem]">
